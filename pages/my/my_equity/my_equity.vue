		...
		<view class="bottom">
			<view class="item" v-for="(row,i) in list" :key="i">
				...
				<view class="flex-center-center">
					<navigator :url="'/pages/my/my_equity/book?id=' + row.id" hover-class="none" class="book">股权证书</navigator>
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		methods:{
			...
			jump_info (e) {
				...
				uni.navigateTo({
					url:'/pages/my/my_equity/info?data=' + data
				})
			},
			back () {
				uni.navigateBack()
